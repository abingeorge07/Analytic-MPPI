"""Render a video + provenance bundle for configs/exp/walker_fpl_mppi.py.

Sibling of render_walker_vanilla_video.py -- see that module's docstring for the
layout/provenance rationale. No runs/capability/walker/ bundle existed before this task
(clean slate, unlike hopper where a capability_probe.py exploration already existed), so
this script is what produces the FPL arm's flagship bundle directly from
configs/exp/walker_fpl_mppi.py's resolved config.

Run:  a-mppi/bin/python verification/render_walker_fpl_video.py
"""
...
CONFIG_PATH = "configs/exp/walker_fpl_mppi.py"
TAG = "mppi_fpl_K256_10s"
